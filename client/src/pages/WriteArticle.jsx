...
// Fetch backend url to make the API call
...
const WriteArticle = () => {
  ...
  // Get the token for authentication and authorization of the user
  ...
  return (
    <div className='h-full overflow-y-scroll p-4 flex items-start flex-wrap gap-4 text-slate-700'>
      {/* Left Column */}
