...
const Sidebar = ({sidebar, setSidebar}) => {
  ...
  return (
    <div className={`w-60 bg-white border-r border-gray-200 flex flex-col justify-between items-center h-full max-sm:absolute max-sm:top-0 max-sm:bottom-0 ${sidebar ? 'max-sm:translate-x-0' : 'max-sm:-translate-x-full'} transition-all duration-300 ease-in-out z-20`}>
